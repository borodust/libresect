...
typedef enum {
    RESECT_INCLUSION_STATUS_UNKNOWN = 0,
    RESECT_INCLUSION_STATUS_INCLUDED = 1,
    RESECT_INCLUSION_STATUS_EXCLUDED = 2,
    RESECT_INCLUSION_STATUS_ENFORCED = 3,
    RESECT_INCLUSION_STATUS_REJECTED = 4,
...
RESECT_API resect_collection resect_decl_template_specializations(resect_decl decl);
...
RESECT_API void resect_options_ignore_definition(resect_parse_options opts, const char *name);

RESECT_API void resect_options_ignore_source(resect_parse_options opts, const char *source);
